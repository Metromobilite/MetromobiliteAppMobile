...
var locationArray = urlFixup("www.metromobilite.fr", documentAlias.location.href, getReferrer());  // VT 19/09/2015 : ATTTENTION www.metromobilite.fr" en dur au lieu de documentAlias.domain qui ne marche pas sous WP8
																								  // VT 19/09/2015 : ATTTENTION documentAlias.location.href au lieu de documentAlias.windowAlias.location.href

//console.log('Piwik.js le probleme sous WP8 vient de  locationArray qui a pour valeur :'  + locationArray + " après ça part en live");
var  domainAlias = domainFixup(locationArray[0]);

var    locationHrefAlias = decodeWrapper(locationArray[1]);
var    configReferrerUrl = decodeWrapper(locationArray[2]);
...
var   configAppendToTrackingUrl = '';
                // Site ID
var    configTrackerSiteId = siteId || '';
...
var   configCustomUrl;
                ...
                // Document title
var   configTitle = documentAlias.title;
...
var   configCustomData;
                ...
                // Campaign names
var   configCampaignNameParameters = [ 'pk_campaign', 'piwik_campaign', 'utm_campaign', 'utm_source', 'utm_medium' ];

                // Campaign keywords
var   configCampaignKeywordParameters = [ 'pk_kwd', 'piwik_kwd', 'utm_term' ];

                // First-party cookie name prefix
var   configCookieNamePrefix = '_pk_';
...
var  configPerformanceTrackingEnabled = true;

                // Generation time set from the server
var   configPerformanceGenerationTime = 0;

                // Whether Custom Variables scope "visit" should be stored in a cookie during the time of the visit
var   configStoreCustomVariablesInCookie = false;

                // Custom Variables read from cookie, scope "visit"
var   customVariables = false;

var   configCustomRequestContentProcessing;

				 // Custom Variables, scope "page"
var    customVariablesPage = {};

                // Custom Variables, scope "event"
var   customVariablesEvent = {};
...
var   trackedContentImpressions = [];
var   isTrackOnlyVisibleContentEnabled = false;

                // Guard to prevent empty visits see #6415. If there is a new visitor and the first 2 (or 3 or 4)
                // tracking requests are at nearly same time (eg trackPageView and trackContentImpression) 2 or more
                // visits will be created
var    timeNextTrackingRequestCanBeExecutedImmediately = false;
